...
$sql = $db->query("SELECT * FROM book ORDER BY sn DESC limit $start_from, $num_per_page");
//if page reload

   if (isset($_POST['q'])) {
    $q = $_POST['q'];
    $filter = $_POST['filter'];
    $sql = $db->query("SELECT * FROM book WHERE $filter LIKE '%$q%' ORDER BY sn DESC");
				...
				<div class="container">
					<div class="col-lg-12 col-md-12">
						<div class="pt-caption text-center mt-5">
							<h1>Our Book Archive</h1>
							<p><a href="index.php">Home</a><span class="current-page">Books</span></p>
						</div>
					</div>
				</div>
			</div>
