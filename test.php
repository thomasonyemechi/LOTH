    ...
    <body>
        ...
        <div id="main-wrapper">
			...
			<div class="hero-banner dark">
				...
				<div class="hero-img">
					<img src="assets/img/banner-8.jpg" class="img-responsive" alt="">
				</div>
				<div class="container">
					<div class="row">
						<div class="col col-lg-8 col-md-9 col-sm-12">
							<div class="content light">
								<h1>We Build <span class="theme-cl">Better</span> & <span class="theme-cl">Blazing</span></h1>
								<p class="lead-i">We create and build flexible & creative design in your budget</p>
								<div class="btn-wrap mt-4">
									<a href="#" class="btn btn-info btn-rounded btn-lg">Find Out More</a>
									<a href="#" data-toggle="modal" data-target="#popup-video" class="btn-trans-video ml-2"><i class="ti-control-play"></i>Watch Video</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 mb-4">
							<div class="middle-icon-features" data-aos="fade-up" data-aos-duration="1200">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 text-center">
							<a class="btn btn-primary btn-lg btn-rounded" href="#">See More Services<i class="ml-2 ti-arrow-right"></i></a>
						</div>
					</div>
			...
			<!-- ============================ Counter Start ================================== -->
			<section class="image-bg default-bg" style="background:#003b77 url(assets/img/pattern.png) repeat;">
				<div class="container">
					<div class="row">
						<div class="col text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-12">
							<div class="row mrg-0 bg-white box-shadow pt-5 border--radius">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="large-features-2 style-1 shadow-0 border-0">
										<div class="large-features-2-thumb">
											<img src="assets/img/market-analysiss.png" class="img-responsive" alt="" />
										</div>
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="large-features-2 style-1 shadow-0 border-0">
										<div class="large-features-2-thumb">
											<img src="assets/img/email-marketing.png" class="img-responsive" alt="" />
										</div>
										<div class="large-features-2-detail">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="large-features-2 style-1 shadow-0 border-0">
										<div class="large-features-2-thumb">
											<img src="assets/img/keyword.png" class="img-responsive" alt="" />
										</div>
										<div class="large-features-2-detail">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									<div class="large-features-2 style-1 shadow-0 border-0">
										<div class="large-features-2-thumb">
											<img src="assets/img/article.png" class="img-responsive" alt="" />
										</div>
										<div class="large-features-2-detail">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<h2>Why <span class="theme-cl">35,000 People</span> Trust On Unico?</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
							<ul class="list-style style-1">
								...
								<li>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium</li>
								<li>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiism</li>
								<li>At vero eos et accusamus et iusto odio dignissimos ducimus</li>
								<li>At vero eos et accusamus et iusto odio dignissimos ducimus</li>
							</ul>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<img src="assets/img/seo-smo.png" class="img-fluid mx-auto" alt="" data-aos="fade-right" data-aos-duration="1200">
						</div>
			...
			<section class="cover height-80 imagebg text-center" data-overlay="5">
                <div class="bg-img-holder" style="background: url(assets/img/31.jpg); opacity: 1;">
                    <img alt="background" src="assets/img/bn1.jpg">
                </div>
                <div class="container pos-vertical-center">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-8 ">
                            <h1 class="mb-4">
                                Streamline your workflow with Unico
                            </h1>
							
							<div class="video-block">
                                <div class="video-play-icon modal-trigger">
									<a href="#" data-toggle="modal" data-target="#popup-video"><i class="fa fa-play" aria-hidden="true"></i></a>
								</div>
                             </div>
                            <a class="btn btn-primary border--radius mt-2" href="#">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4">
							<div class="pricing-wrap pricing-1 mb-4">
								<div class="pricing-header">
									<div class="package-type">
										<p>Basic</p>
									</div>
									<div class="package-price">
										<h2><sup>$</sup>70<sub>/Month</sub></h2>
									</div>
								</div>
								<div class="pricing-detail">
									<ul>
										<li><span>10 Video Upload</span></li>
										<li><span>2 Messages</span></li>
										<li><span>5 Contact</span></li>
										<li><span>3 GB Data</span></li>
										<li class="disable"><span>Unlimited Time</span></li>
										<li class="disable"><span>Trial 14 Days</span></li>
									</ul>
								</div>
								<div class="buy-now">
						...
						<div class="col-lg-4 col-md-4">
							<div class="pricing-wrap pricing-1 featured-price mb-4">
								<div class="pricing-header">
									<div class="package-type">
										<p>Standard</p>
									</div>
								...
								<div class="pricing-detail">
									<ul>
										<li><span>20 Video Upload</span></li>
										<li><span>4 Messages</span></li>
										<li><span>10 Contact</span></li>
										<li><span>10 GB Data</span></li>
						...
						<div class="col-lg-4 col-md-4">
							<div class="pricing-wrap pricing-1 mb-4">
								<div class="pricing-header">
									...
									<div class="package-price">
										<h2><sup>$</sup>199<sub>/Month</sub></h2>
									</div>
								</div>
								<div class="pricing-detail">
									<ul>
										<li><span>50 Video Upload</span></li>
										<li><span>20 Messages</span></li>
										<li><span>20 Contact</span></li>
										<li><span>30 GB Data</span></li>
										<li><span>Unlimited Time</span></li>
										<li><span>Trial 14 Days</span></li>
									</ul>
								</div>
								<div class="buy-now">
									<a href="#" class="buy-btn">Get Started</a>
			...
			<section class="company-brand">
				<div class="container">
					...
					<div class="row">
						...
						<div class="owl-carousel" id="company-brand">
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-1.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-2.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-3.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-4.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-5.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-6.png" alt="">
							</div>
							
							<!-- Single Company Brand -->
							<div class="item">
								<img src="assets/img/shop-logo-7.png" alt="">
							</div>
			...
			<!-- ============================ Footer Start ================================== -->
			<footer class="bg-cover skin-dark-footer" style="background:#0d1527 url(assets/img/app1.png) no-repeat">
				<div>
					<div class="container">
						<div class="row">
