  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Search Client</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
          <div class="card-body">
            <strong style="float: left">Input Email And Click Search</strong>
                  ...
                  <form method="post">
                      ...
                      <table>
                          <tr>
                              ...
                              <td><button type="submit" name="searchclient" class="btn btn-warning btn-block">Search</button></td>
                          </tr>
                      </table>
                  </form>
              </div>
                          ...
                          <?php if (isset($_SESSION['seachclient'])) {
                        $client = $_SESSION['seachclient']; ?>
                 ...
                 <div class="col-md-12 col-12">
                  <strong> Biography</strong>
                   ...
                   <p class="text-center" >
                                    ...
                                    <a class="btn btn-success" href="updatecategory.php" data-toggle="modal" data-target="#updatecategory">Update Category</a></p>
                 </div>
