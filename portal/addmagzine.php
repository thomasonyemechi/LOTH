...
<div class="wrapper">
  ...
  <?php include('nav.php'); ?>
  <?php
  $mn = $db->query("SELECT * FROM magzine ORDER BY sn DESC LIMIT 1 ");
    $fmn = mysqli_fetch_array($mn);
    $mn = date('n', strtotime($fmn['created']));
    ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Create Magazine</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
                  ...
                  while ($ro = mysqli_fetch_array($sql)) {  ?>
                      ...
                      <form method="post">
                          ...
                          <div class="form-group">
                              ...
                              <textarea name="detail" class="form-control" id="editor1" rows="4"><?php echo $ro['detail'];  ?></textarea>
                          </div>
                    ...
                    <form method="post" enctype="multipart/form-data"> 
                      <div class="row">
                         <h4 class="col-lg-12 card-title">Month: <?php echo date('F'); ?></h4>
                    ...
                    <div class="col-lg-12 form-group">
                      <label for="exampleTextarea1">Summary Of Magazine</label>
                      <textarea name="subtitle" class="form-control" rows="4"></textarea>
                    </div>
                     <div class="col-lg-12 form-group">
                      <label for="exampleTextarea1">Detail Of Magazine</label>
                      <textarea name="detail" id="editor1" class="form-control" rows="4"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary mr-2" name="insertMagzine">Save</button>
                  </div>
                  </form>

                  <?php } else {
                          echo 'Magine for this month has been uploaded.';
                      }
                  } ?>
              </div>
            </div>
          ...
          <section class="col-lg-12">
            <div class="card card-secondary">
              ...
              <tbody>
                  <?php $i = 1;
                  $query = $db->query("SELECT * FROM magzine ORDER BY sn DESC") or die(mysqli_error());
                  ...
                  ?>
                      <tr>
                          ...
                          <td> 
                          <?php
                              if ($mn == date('F/y')) { echo '<button type="submit" name="edit" value="" class="btn btn-primary">Edit</button>'; }
                              else{echo '<button disabled class="btn btn-success">Completed</button>';}
                          ?> 
                          </td>
                      </tr>
                  <?php } ?>
