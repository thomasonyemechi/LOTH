...
<div class="wrapper">
  ...
  <?php include('nav.php'); ?>
  <?php 
  // if(array_key_exists('updatetest', $_POST)){
  //   $sn = $_POST['updatetest'];
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
<?php if(isset($report)){echo $pro->Alert(); } $sql = $db->query("SELECT * FROM testimony ORDER BY sn DESC LIMIT 100 "); ?>
    <!-- Main content -->
                ...
                <table id="example1" class="table table-sm">
                  <thead>
                    ...
                    <tr>
                        ...
                        <?php if($row['status'] == 1){ ?>
                        <td><form method="post"><button type="submit" class="btn btn-sm btn-info" name="updatetest" value="<?php echo $row['sn']; ?>">Mark as read</button></form></td>
                    <?php }else{ ?>
