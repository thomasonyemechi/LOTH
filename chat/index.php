		...
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					...
					echo '<div class="wrap">';
						echo '<img id="profile-img" src="../portal/uphoto/'.$user['photo'].'" class="online" alt="" />';
						echo  '<b style="padding-left:7px;">'.ucwords(userName($user['id'])).'</b>';
					...
					<div id="search">
						<label for=""></label>
						<input type="text" placeholder="Your Group Mates" />					
					</div>
					<div id="contacts">	
					<?php
					echo '<ul>';
					...
					while($user = mysqli_fetch_assoc($chatUsers)) {
						...
						echo '<img src="../portal/uphoto/'.$user['photo'].'" alt="" />';
						echo '<div class="meta">';
				...
				<div class="content" id="content"> 
					...
					<?php									
							echo '<p>'.ucfirst($pro->category(userName($uid, 'category'))).' Chat Group </p>';
