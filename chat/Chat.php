...
define("DB_USER", "thehillt_hilluser");//enter your database username
define("DB_PASS", "light.com");   //databse password
define("DB_NAME", "thehillt_hilldb");//database name


$db = new mysqli(DB_SERVER1, DB_USER1, DB_PASS1, DB_NAME1);
...
class Chat{
	...
	public function ggetUserDetails($userid){
		global $db;
		$sql =$db->query("SELECT * FROM user WHERE id = '$userid'");
